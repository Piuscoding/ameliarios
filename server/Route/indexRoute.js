...
const { homePage, aboutPage, contactPage, affliatePage, faqPage, termsPage,  registerPage, loginPage, invplanPage, verifyPage, statisticPage, register_post, login_post, logout_get, loginAdmin } = require("../controllers/userController");
