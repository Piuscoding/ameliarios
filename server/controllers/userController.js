...
module.exports.register_post = async (req, res) =>{
    const {username,fullname,country, gender,tel,email, password,ref } = req.body;
    try {
        const user = await User.create({username, fullname,country, gender, tel, email,  password, ref });
